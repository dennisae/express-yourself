...
b || {};Va && Ua(a) ? (ta(`screen`, a, b), b.x += q.scrollX, b.y += q.scrollY) : ta(`page`, a, b);return b;} function Wa(a, b) {b = b || {};Va && Ua(a) ? ta(`screen`, a, b) : ta(`client`, a, b);return b;} function O(a) {return K(a.pointerId) ? a.pointerId : a.identifier;} function Ea(a) {return a instanceof nb ? a.correspondingUseElement : a;} function V(a) {if (Ba(a)) return a;a = a.ownerDocument || a;return a.defaultView || a.parentWindow || q;} function Fa(a) {return (a = a instanceof Xa ? a.getBoundingClientRect() : a.getClientRects()[0]) && {left: a.left, right: a.right,
  top: a.top, bottom: a.bottom, width: a.width || a.right - a.left, height: a.height || a.bottom - a.top};} function ua(a) {let b, c = Fa(a);!ob && c && (b = (b = V(a)) || q, a = b.scrollX || b.document.documentElement.scrollLeft, b = b.scrollY || b.document.documentElement.scrollTop, c.left += a, c.right += a, c.top += b, c.bottom += b);return c;} function Ga(a) {const b = [];da(a) ? (b[0] = a[0], b[1] = a[1]) : `touchend` === a.type ? 1 === a.touches.length ? (b[0] = a.touches[0], b[1] = a.changedTouches[0]) : 0 === a.touches.length && (b[0] = a.changedTouches[0], b[1] = a.changedTouches[1]) :
(b[0] = a.touches[0], b[1] = a.touches[1]);return b;} function Ya(a) {for (var b = {pageX: 0, pageY: 0, clientX: 0, clientY: 0, screenX: 0, screenY: 0}, c, d = 0;d < a.length;d ++) for (c in b)b[c] += a[d][c];for (c in b)b[c] /= a.length;return b;} function Ha(a) {if (a.length || a.touches && 1 < a.touches.length) {a = Ga(a);let b = Math.min(a[0].pageX, a[1].pageX), c = Math.min(a[0].pageY, a[1].pageY);return {x: b, y: c, left: b, top: c, width: Math.max(a[0].pageX, a[1].pageX) - b, height: Math.max(a[0].pageY, a[1].pageY) - c};}} function Ia(a, b) {b = b || D.deltaSource;let c =
`${b}X`, d = `${b}Y`, e = Ga(a);return fa(e[0][c] - e[1][c], e[0][d] - e[1][d]);} function Ja(a, b, c) {c = c || D.deltaSource;let d = `${c}X`;c += `Y`;a = Ga(a);d = 180 * Math.atan((a[0][c] - a[1][c]) / (a[0][d] - a[1][d])) / Math.PI;K(b) && (b = (d - b) % 360, 315 < b ? d -= 360 + d / 360 | 0 : 135 < b ? d -= 180 + d / 360 | 0 : - 315 > b ? d += 360 + d / 360 | 0 : - 135 > b && (d += 180 + d / 360 | 0));return d;} function na(a, b) {let c = a ? a.options.origin : D.origin;`parent` === c ? c = L(b) : `self` === c ? c = a.getRect(b) : ea(c) && (c = Ka(b, c) || {x: 0, y: 0});A(c) && (c = c(a && b));t(c) && (c = ua(c));c.x = `x` in c ? c.x : c.left;c.y = `y` in
c ? c.y : c.top;return c;} function Za(a, b, c, d) {const e = 1 - a;return e * e * b + 2 * e * a * c + a * a * d;} function Y(a, b) {for (;b;) {if (b === a) return !0;b = b.parentNode;} return !1;} function Ka(a, b) {for (var c = L(a);t(c);) {if (R(c, b)) return c;c = L(c);} return null;} function L(a) {if ((a = a.parentNode) && a instanceof $a) for (;(a = a.host) && a && a instanceof $a;);return a;} function va(a, b) {return a._context === b.ownerDocument || Y(a._context, b);} function Z(a, b, c) {return (a = a.options.ignoreFrom) && t(c) ? N(a) ? La(c, a, b) : t(a) ? Y(a, c) : !1 : !1;} function aa(a, b, c) {return (a =
a.options.allowFrom) ? t(c) ? N(a) ? La(c, a, b) : t(a) ? Y(a, c) : !1 : !1 : !0;} function ab(a, b) {if (!b) return !1;const c = b.options.drag.axis;return `xy` === a || `xy` === c || c === a;} function Ma(a, b) {const c = a.options;/^resize/.test(b) && (b = `resize`);return c[b].snap && c[b].snap.enabled;} function Na(a, b) {const c = a.options;/^resize/.test(b) && (b = `resize`);return c[b].restrict && c[b].restrict.enabled;} function ha(a, b, c) {for (var d = a.options, e = d[c.name].max, d = d[c.name].maxPerElement, h = 0, f = 0, g = 0, k = 0, y = r.length;k < y;k ++) {let n = r[k], u = n.prepared.name;
  if (n.interacting() && (h ++, h >= wa || n.target === a && (f += u === c.name | 0, f >= e || n.element === b && (g ++, u !== c.name || g >= d)))) return !1;} return 0 < wa;} function xa() {this.prevDropElement = this.prevDropTarget = this.dropElement = this.dropTarget = this.element = this.target = null;this.prepared = {name: null, axis: null, edges: null};this.matches = [];this.matchElements = [];this.inertiaStatus = {active: !1, smoothEnd: !1, ending: !1, startEvent: null, upCoords: {}, xe: 0, ye: 0, sx: 0, sy: 0, t0: 0, vx0: 0, vys: 0, duration: 0, resumeDx: 0, resumeDy: 0, lambda_v0: 0, one_ve_v0: 0,
    i: null};if (A(Function.prototype.bind)) this.boundInertiaFrame = this.inertiaFrame.bind(this), this.boundSmoothEndFrame = this.smoothEndFrame.bind(this);else {const a = this;this.boundInertiaFrame = function() {return a.inertiaFrame();};this.boundSmoothEndFrame = function() {return a.smoothEndFrame();};} this.activeDrops = {dropzones: [], elements: [], rects: []};this.pointers = [];this.pointerIds = [];this.downTargets = [];this.downTimes = [];this.holdTimers = [];this.prevCoords = {page: {x: 0, y: 0}, client: {x: 0, y: 0}, timeStamp: 0};this.curCoords =
{page: {x: 0, y: 0}, client: {x: 0, y: 0}, timeStamp: 0};this.startCoords = {page: {x: 0, y: 0}, client: {x: 0, y: 0}, timeStamp: 0};this.pointerDelta = {page: {x: 0, y: 0, vx: 0, vy: 0, speed: 0}, client: {x: 0, y: 0, vx: 0, vy: 0, speed: 0}, timeStamp: 0};this.downEvent = null;this.downPointer = {};this.prevEvent = this._curEventTarget = this._eventTarget = null;this.tapTime = 0;this.prevTap = null;this.startOffset = {left: 0, right: 0, top: 0, bottom: 0};this.restrictOffset = {left: 0, right: 0, top: 0, bottom: 0};this.snapOffsets = [];this.gesture = {start: {x: 0, y: 0}, startDistance: 0,
  prevDistance: 0, distance: 0, scale: 1, startAngle: 0, prevAngle: 0};this.snapStatus = {x: 0, y: 0, dx: 0, dy: 0, realX: 0, realY: 0, snappedX: 0, snappedY: 0, targets: [], locked: !1, changed: !1};this.restrictStatus = {dx: 0, dy: 0, restrictedX: 0, restrictedY: 0, snap: null, restricted: !1, changed: !1};this.restrictStatus.snap = this.snapStatus;this.resizing = this.dragging = this.gesturing = this.pointerWasMoved = this.pointerIsDown = !1;this.resizeAxes = `xy`;this.mouse = !1;r.push(this);} function bb(a, b, c) {let d = 0, e = r.length, h = /mouse/i.test(a.pointerType ||
b) || 4 === a.pointerType, f;a = O(a);if (/down|start/i.test(b)) for (d = 0;d < e;d ++) {f = r[d];let g = c;if (f.inertiaStatus.active && f.target.options[f.prepared.name].inertia.allowResume && f.mouse === h) for (;g;) {if (g === f.element) return f;g = L(g);}} if (h || !ga && !oa) {for (d = 0;d < e;d ++) if (r[d].mouse && !r[d].inertiaStatus.active) return r[d];for (d = 0;d < e;d ++) if (r[d].mouse && (!/down/.test(b) || !r[d].inertiaStatus.active)) return f;f = new xa;f.mouse = !0;return f;} for (d = 0;d < e;d ++) if (- 1 !== v(r[d].pointerIds, a)) return r[d];if (/up|end|out/i.test(b)) return null;
    for (d = 0;d < e;d ++) if (f = r[d], !(f.prepared.name && !f.target.options.gesture.enabled || f.interacting() || !h && f.mouse)) return f;return new xa;} function cb(a) {return function(b) {let c, d = Ea(b.path ? b.path[0] : b.target), e = Ea(b.currentTarget), h;if (ga && /touch/.test(b.type)) for (db = (new Date).getTime(), h = 0;h < b.changedTouches.length;h ++) {const f = b.changedTouches[h];if (c = bb(f, b.type, d))c._updateEventTargets(d, e), c[a](f, b, d, e);} else {if (!oa && /mouse/.test(b.type)) {for (h = 0;h < r.length;h ++) if (!r[h].mouse && r[h].pointerIsDown) return;
      if (500 > (new Date).getTime() - db) return;} if (c = bb(b, b.type, d))c._updateEventTargets(d, e), c[a](b, b, d, e);}};} function G(a, b, c, d, e, h) {let f, g, k = a.target, y = a.snapStatus, n = a.restrictStatus, u = a.pointers, E = (k && k.options || D).deltaSource, eb = `${E}X`, l = `${E}Y`, ia = k ? k.options : D, w = na(k, e), m = `start` === d, p = `end` === d;f = m ? a.startCoords : a.curCoords;e = e || a.element;g = x({}, f.page);f = x({}, f.client);g.x -= w.x;g.y -= w.y;f.x -= w.x;f.y -= w.y;const I = ia[c].snap && ia[c].snap.relativePoints;!Ma(k, c) || m && I && I.length || (this.snap = {range: y.range,
...
(292.5 <= d || 67.5 > d), angle: d, speed: a.prevEvent.speed, velocity: {x: a.prevEvent.velocityX, y: a.prevEvent.velocityY}});} function fb() {this.originalEvent.preventDefault();} function gb(a) {var b = ``;`drag` === a.name && (b = za.drag);if (`resize` === a.name) if (a.axis)b = za[a.name + a.axis];else if (a.edges) {for (var b = `resize`, c = [`top`, `bottom`, `left`, `right`], d = 0;4 > d;d ++)a.edges[c[d]] && (b += c[d]);b = za[b];} return b;} function hb(a, b, c) {a = this.getRect(c);var d = !1, e = null, h = null, f, g = x({}, b.curCoords.page), e = this.options;if (!a) return null;
  if (S.resize && e.resize.enabled) if (d = e.resize, f = {left: !1, right: !1, top: !1, bottom: !1}, z(d.edges)) {for (const k in f) {var y = f, n = k, u;a: {u = k;let E = d.edges[k], l = g, m = b._eventTarget, p = c, w = a, ya = d.margin || pa;if (E) {if (!0 === E) {let q = K(w.width) ? w.width : w.right - w.left, I = K(w.height) ? w.height : w.bottom - w.top;0 > q && (`left` === u ? u = `right` : `right` === u && (u = `left`));0 > I && (`top` === u ? u = `bottom` : `bottom` === u && (u = `top`));if (`left` === u) {u = l.x < (0 <= q ? w.left : w.right) + ya;break a;} if (`top` === u) {u = l.y < (0 <= I ? w.top : w.bottom) + ya;break a;} if (`right` ===
...
`mouseup`, m.pointerUp), n.add(a, `mouseover`, m.pointerOver), n.add(a, `mouseout`, m.pointerOut), n.add(a, `touchstart`, m.selectorDown), n.add(a, `touchmove`, m.pointerMove), n.add(a, `touchend`, m.pointerUp), n.add(a, `touchcancel`, m.pointerCancel), n.add(a, `mousemove`, m.autoScrollMove), n.add(a, `touchmove`, m.autoScrollMove));n.add(b, `blur`, jb);try {if (b.frameElement) {let d = b.frameElement.ownerDocument, e = d.defaultView;n.add(d, `mouseup`, m.pointerEnd);n.add(d, `touchend`, m.pointerEnd);n.add(d, `touchcancel`, m.pointerEnd);
  n.add(d, `pointerup`, m.pointerEnd);n.add(d, `MSPointerUp`, m.pointerEnd);n.add(e, `blur`, jb);}} catch (h) {l.windowParentError = h;}n.add(a, `dragstart`, function(a) {for (var b = 0;b < r.length;b ++) {const c = r[b];if (c.element && (c.element === a.target || Y(c.element, a.target))) {c.checkAndPreventDefault(a, c.target, c.element);break;}}});n.useAttachEvent && (n.add(a, `selectstart`, function(a) {const b = r[0];b.currentAction() && b.checkAndPreventDefault(a);}), n.add(a, `dblclick`, cb(`ie8Dblclick`)));ja.push(a);}} function v(a, b) {for (var c = 0,
    d = a.length;c < d;c ++) if (a[c] === b) return c;return - 1;} function R(a, b, c) {if (ka) return ka(a, b, c);q !== F && (b = b.replace(/\/deep\//g, ` `));return a[Oa](b);} function La(a, b, c) {for (;t(a);) {if (R(a, b)) return !0;a = L(a);if (a === c) return R(a, b);} return !1;} if (F) {var q = function() {const a = F.document.createTextNode(``);return a.ownerDocument !== F.document && `function` === typeof F.wrap && F.wrap(a) === a ? F.wrap(F) : F;}(), Q = q.document, $a = q.DocumentFragment || ma, Xa = q.SVGElement || ma, pb = q.SVGSVGElement || ma, nb = q.SVGElementInstance || ma, qb = q.HTMLElement ||
...
this.setActiveDrops(this.element);a = this.getDropEvents(a, b);a.activate && this.fireActiveDrops(a.activate);return b;}, dragMove: function(a) {let b = this.target, c = new G(this, a, `drag`, `move`, this.element), d = this.getDrop(c, a, this.element);this.dropTarget = d.dropzone;this.dropElement = d.element;a = this.getDropEvents(a, c);b.fire(c);a.leave && this.prevDropTarget.fire(a.leave);a.enter && this.dropTarget.fire(a.enter);a.move && this.dropTarget.fire(a.move);this.prevDropTarget = this.dropTarget;this.prevDropElement = this.dropElement;
  return c;}, resizeStart: function(a) {a = new G(this, a, `resize`, `start`, this.element);if (this.prepared.edges) {const b = this.target.getRect(this.element);if (this.target.options.resize.square || this.target.options.resize.preserveAspectRatio) {const c = x({}, this.prepared.edges);c.top = c.top || c.left && !c.bottom;c.left = c.left || c.top && !c.right;c.bottom = c.bottom || c.right && !c.top;c.right = c.right || c.bottom && !c.left;this.prepared._linkedEdges = c;} else this.prepared._linkedEdges = null;this.target.options.resize.preserveAspectRatio &&
(this.resizeStartAspectRatio = b.width / b.height);this.resizeRects = {start: b, current: x({}, b), restricted: x({}, b), previous: x({}, b), delta: {left: 0, right: 0, width: 0, top: 0, bottom: 0, height: 0}};a.rect = this.resizeRects.restricted;a.deltaRect = this.resizeRects.delta;} this.target.fire(a);this.resizing = !0;return a;}, resizeMove: function(a) {a = new G(this, a, `resize`, `move`, this.element);var b = this.prepared.edges, c = this.target.options.resize.invert, d = `reposition` === c || `negate` === c;if (b) {let e = a.dx, h = a.dy, f = this.resizeRects.start,
...
`drag`, `end`, this.element), q = this.getDrop(e, b, this.element), this.dropTarget = q.dropzone, this.dropElement = q.element, q = this.getDropEvents(b, e), q.leave && this.prevDropTarget.fire(q.leave), q.enter && this.dropTarget.fire(q.enter), q.drop && this.dropTarget.fire(q.drop), q.deactivate && this.fireActiveDrops(q.deactivate), h.fire(e)) : this.resizing ? (e = new G(this, b, `resize`, `end`, this.element), h.fire(e)) : this.gesturing && (e = new G(this, b, `gesture`, `end`, this.element), h.fire(e));this.stop(b);}, collectDrops: function(a) {let b =
[], c = [], d;a = a || this.element;for (d = 0;d < B.length;d ++) if (B[d].options.drop.enabled) {var e = B[d], h = e.options.drop.accept;if (!(t(h) && h !== a || N(h) && !R(a, h))) for (var h = e.selector ? e._context.querySelectorAll(e.selector) : [e._element], f = 0, g = h.length;f < g;f ++) {const k = h[f];k !== a && (b.push(e), c.push(k));}} return {dropzones: b, elements: c};}, fireActiveDrops: function(a) {let b, c, d, e;for (b = 0;b < this.activeDrops.dropzones.length;b ++)c = this.activeDrops.dropzones[b], d = this.activeDrops.elements[b], d !== e && (a.target = d, c.fire(a)),
e = d;}, setActiveDrops: function(a) {a = this.collectDrops(a, !0);this.activeDrops.dropzones = a.dropzones;this.activeDrops.elements = a.elements;this.activeDrops.rects = [];for (a = 0;a < this.activeDrops.dropzones.length;a ++) this.activeDrops.rects[a] = this.activeDrops.dropzones[a].getRect(this.activeDrops.elements[a]);}, getDrop: function(a, b, c) {let d = [];Pa && this.setActiveDrops(c);for (var e = 0;e < this.activeDrops.dropzones.length;e ++) {var h = this.activeDrops.elements[e];d.push(this.activeDrops.dropzones[e].dropCheck(a, b,
this.target, c, h, this.activeDrops.rects[e]) ? h : null);}c = (b = d[0]) ? 0 : - 1;for (var f, e = [], g = [], h = 1;h < d.length;h ++) if ((a = d[h]) && a !== b) if (!b)b = a, c = h;else if (a.parentNode !== a.ownerDocument) if (b.parentNode === a.ownerDocument)b = a, c = h;else {if (!e.length) for (f = b;f.parentNode && f.parentNode !== f.ownerDocument;)e.unshift(f), f = f.parentNode;if (b instanceof qb && a instanceof Xa && !(a instanceof pb)) {if (a === b.parentNode) continue;f = a.ownerSVGElement;} else f = a;for (g = [];f.parentNode !== f.ownerDocument;)g.unshift(f), f = f.parentNode;
  for (f = 0;g[f] && g[f] === e[f];)f ++;f = [g[f - 1], g[f], e[f]];for (g = f[0].lastChild;g;) {if (g === f[1]) {b = a;c = h;e = [];break;} else if (g === f[2]) break;g = g.previousSibling;}}d = c;return {dropzone: this.activeDrops.dropzones[d] || null, element: this.activeDrops.elements[d] || null};}, getDropEvents: function(a, b) {const c = {enter: null, leave: null, activate: null, deactivate: null, move: null, drop: null};this.dropElement !== this.prevDropElement && (this.prevDropTarget && (c.leave = {target: this.prevDropElement, dropzone: this.prevDropTarget, relatedTarget: b.target,
...
this.prevDropTarget = this.prevDropElement = this.target = this.element = null;}, stop: function(a) {if (this.interacting()) {p.stop();this.matches = [];this.matchElements = [];const b = this.target;b.options.styleCursor && (b._doc.documentElement.style.cursor = ``);a && A(a.preventDefault) && this.checkAndPreventDefault(a, b, this.element);this.dragging && (this.activeDrops.dropzones = this.activeDrops.elements = this.activeDrops.rects = null);} this.clearTargets();this.pointerIsDown = this.snapStatus.locked = this.dragging = this.resizing = this.gesturing =
!1;this.prepared.name = this.prevEvent = null;for (a = this.inertiaStatus.resumeDx = this.inertiaStatus.resumeDy = 0;a < this.pointers.length;a ++)- 1 === v(this.pointerIds, O(this.pointers[a])) && this.pointers.splice(a, 1);}, inertiaFrame: function() {let a, b, c = this.inertiaStatus;a = this.target.options[this.prepared.name].inertia.resistance;b = (new Date).getTime() / 1E3 - c.t0;if (b < c.te) {b = 1 - (Math.exp(- a * b) - c.lambda_v0) / c.one_ve_v0;if (c.modifiedXe === c.xe && c.modifiedYe === c.ye)c.sx = c.xe * b, c.sy = c.ye * b;else {let d = c.ye, e = c.modifiedYe;
  a = Za(b, 0, c.xe, c.modifiedXe);b = Za(b, 0, d, e);c.sx = a;c.sy = b;} this.pointerMove(c.startEvent, c.startEvent);c.i = T(this.boundInertiaFrame);} else c.ending = !0, c.sx = c.modifiedXe, c.sy = c.modifiedYe, this.pointerMove(c.startEvent, c.startEvent), this.pointerEnd(c.startEvent, c.startEvent), c.active = c.ending = !1;}, smoothEndFrame: function() {let a = this.inertiaStatus, b = (new Date).getTime() - a.t0, c = this.target.options[this.prepared.name].inertia.smoothEndDuration;if (b < c) {let d;d = b / c;a.sx = - a.xe * d * (d - 2) + 0;b /= c;a.sy = - a.ye * b * (b -
2) + 0;this.pointerMove(a.startEvent, a.startEvent);a.i = T(this.boundSmoothEndFrame);} else a.ending = !0, a.sx = a.xe, a.sy = a.ye, this.pointerMove(a.startEvent, a.startEvent), this.pointerEnd(a.startEvent, a.startEvent), a.smoothEnd = a.active = a.ending = !1;}, addPointer: function(a) {let b = O(a), c = this.mouse ? 0 : v(this.pointerIds, b);- 1 === c && (c = this.pointerIds.length);this.pointerIds[c] = b;this.pointers[c] = a;return c;}, removePointer: function(a) {a = O(a);a = this.mouse ? 0 : v(this.pointerIds, a);- 1 !== a && (this.pointers.splice(a, 1), this.pointerIds.splice(a,
1), this.downTargets.splice(a, 1), this.downTimes.splice(a, 1), this.holdTimers.splice(a, 1));}, recordPointer: function(a) {const b = this.mouse ? 0 : v(this.pointerIds, O(a));- 1 !== b && (this.pointers[b] = a);}, collectEventTargets: function(a, b, c, d) {function e(a, b, e) {e = ka ? e.querySelectorAll(b) : void 0;a._iEvents[d] && t(k) && va(a, k) && !Z(a, k, c) && aa(a, k, c) && R(k, b, e) && (f.push(a), g.push(k));} const h = this.mouse ? 0 : v(this.pointerIds, O(a));if (`tap` !== d || !this.pointerWasMoved && this.downTargets[h] && this.downTargets[h] === c) {for (var f = [],
  g = [], k = c;k;)l.isSet(k) && l(k)._iEvents[d] && (f.push(l(k)), g.push(k)), B.forEachSelector(e), k = L(k);(f.length || `tap` === d) && this.firePointers(a, b, c, f, g, d);}}, firePointers: function(a, b, c, d, e, h) {let f = this.mouse ? 0 : v(this.pointerIds, O(a)), g = {}, k, l;`doubletap` === h ? g = a : (ra(g, b), b !== a && ra(g, a), g.preventDefault = fb, g.stopPropagation = G.prototype.stopPropagation, g.stopImmediatePropagation = G.prototype.stopImmediatePropagation, g.interaction = this, g.timeStamp = (new Date).getTime(), g.originalEvent = b, g.originalPointer = a,
...
a.xe = (a.vx0 - d) / c;a.modifiedYe = a.ye = (a.vy0 - d) / c;a.te = d;a.lambda_v0 = c / a.v0;a.one_ve_v0 = 1 - b.endSpeed / a.v0;}, autoScrollMove: function(a) {let b;if (b = this.interacting()) {b = this.prepared.name;var c = this.target.options;/^resize/.test(b) && (b = `resize`);b = c[b].autoScroll && c[b].autoScroll.enabled;} if (b) if (this.inertiaStatus.active)p.x = p.y = 0;else {let d, e = this.target.options[this.prepared.name].autoScroll, h = e.container || V(this.element);Ba(h) ? (d = a.clientX < p.margin, b = a.clientY < p.margin, c = a.clientX > h.innerWidth - p.margin,
...
this) : H(a) ? (this.options.drag.enabled = a, this) : this.options.drag;}, setPerAction: function(a, b) {for (const c in b)c in D[a] && (z(b[c]) ? (this.options[a][c] = x(this.options[a][c] || {}, b[c]), z(D.perAction[c]) && `enabled` in D.perAction[c] && (this.options[a][c].enabled = !1 === b[c].enabled ? !1 : !0)) : H(b[c]) && z(D.perAction[c]) ? this.options[a][c].enabled = b[c] : void 0 !== b[c] && (this.options[a][c] = b[c]));}, dropzone: function(a) {return z(a) ? (this.options.drop.enabled = !1 === a.enabled ? !1 : !0, this.setOnEvents(`drop`, a), /^(pointer|center)$/.test(a.overlap) ?
this.options.drop.overlap = a.overlap : K(a.overlap) && (this.options.drop.overlap = Math.max(Math.min(1, a.overlap), 0)), `accept` in a && (this.options.drop.accept = a.accept), `checker` in a && (this.options.drop.checker = a.checker), this) : H(a) ? (this.options.drop.enabled = a, this) : this.options.drop;}, dropCheck: function(a, b, c, d, e, h) {var f = !1;if (!(h = h || this.getRect(e))) return this.options.drop.checker ? this.options.drop.checker(a, b, f, this, e, c, d) : !1;const g = this.options.drop.overlap;if (`pointer` === g) {var k = Da(a), f = na(c, d);k.x +=
...
a[d], b);return this;}`wheel` === a && (a = kb);c = c ? !0 : !1;if (- 1 !== v(ca, a))a in this._iEvents ? this._iEvents[a].push(b) : this._iEvents[a] = [b];else if (this.selector) {if (!P[a]) for (P[a] = {selectors: [], contexts: [], listeners: []}, d = 0;d < ja.length;d ++)n.add(ja[d], a, qa), n.add(ja[d], a, Aa, !0);a = P[a];for (d = a.selectors.length - 1;0 <= d && (a.selectors[d] !== this.selector || a.contexts[d] !== this._context);d --);- 1 === d && (d = a.selectors.length, a.selectors.push(this.selector), a.contexts.push(this._context), a.listeners.push([]));a.listeners[d].push([b,
  c]);} else n.add(this._element, a, b, c);return this;}, off: function(a, b, c) {let d;N(a) && - 1 !== a.search(` `) && (a = a.trim().split(/ +/));if (da(a)) {for (d = 0;d < a.length;d ++) this.off(a[d], b, c);return this;} if (z(a)) {for (var e in a) this.off(e, a[e], b);return this;}e = - 1;c = c ? !0 : !1;`wheel` === a && (a = kb);if (- 1 !== v(ca, a))(c = this._iEvents[a]) && - 1 !== (e = v(c, b)) && this._iEvents[a].splice(e, 1);else if (this.selector) {let h = P[a], f = !1;if (!h) return this;for (e = h.selectors.length - 1;0 <= e;e --) if (h.selectors[e] === this.selector && h.contexts[e] ===
this._context) {const g = h.listeners[e];for (d = g.length - 1;0 <= d;d --) {const k = g[d][1];if (g[d][0] === b && k === c) {g.splice(d, 1);g.length || (h.selectors.splice(e, 1), h.contexts.splice(e, 1), h.listeners.splice(e, 1), n.remove(this._context, a, qa), n.remove(this._context, a, Aa, !0), h.selectors.length || (P[a] = null));f = !0;break;}} if (f) break;}} else n.remove(this._element, a, b, c);return this;}, set: function(a) {z(a) || (a = {});this.options = x({}, D.base);let b, c = [`drag`, `drop`, `resize`, `gesture`], d = [`draggable`, `dropzone`, `resizable`, `gesturable`],
  e = x(x({}, D.perAction), a[h] || {});for (b = 0;b < c.length;b ++) {var h = c[b];this.options[h] = x({}, D[h]);this.setPerAction(h, e);this[d[b]](a[h]);}c = `accept actionChecker allowFrom deltaSource dropChecker ignoreFrom origin preventDefault rectChecker styleCursor`.split(` `);b = 0;for (Sa = c.length;b < Sa;b ++) if (d = c[b], this.options[d] = D.base[d], d in a) this[d](a[d]);return this;}, unset: function() {n.remove(this._element, `all`);if (N(this.selector)) for (const a in P) for (var b = P[a];0 < b.selectors.length;) {b.selectors[0] === this.selector &&
